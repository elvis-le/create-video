...
1. Quy Tắc Cảnh Nỗi Đau (Pain Point/Problem): Khi mô tả sự bẩn thỉu, khó khăn hoặc mệt mỏi, TUYỆT ĐỐI KHÔNG dùng các từ khóa tạo sự u ám, kinh dị hoặc tối tăm (CẤM DÙNG: dramatic shadows, dark, gloomy, horror, high contrast, moody lighting). 
2. Ánh Sáng Thương Mại (Commercial Lighting): Mọi phân cảnh đều phải giữ được độ sáng sủa, sạch sẽ của một video quảng cáo. BẮT BUỘC sử dụng các từ khóa: "lifestyle commercial photography, bright and airy lighting, soft natural light, studio lighting, modern well-lit interior".
3. Màu Sắc Thương Hiệu: Luôn điểm xuyết nhẹ nhàng ánh sáng hoặc chi tiết màu xanh lơ (cyan) bằng từ khóa: "subtle cyan #34b1b3 accents" hoặc "soft cyan neon glow".
4. Chất Liệu Cao Cấp: Đối với sản phẩm công nghiệp/đồ gia dụng, luôn sử dụng từ khóa tả chất liệu như: "premium metallic finishes, carbon fiber texture, sleek industrial minimalist design".
5. Chuyển Động Video: Tập trung vào sự mượt mà ("smooth motion, fluid motion, slow motion pan"). Không tả các hành động quá phức tạp gây biến dạng.

[Cấu Trúc Bóc Tách]
Mỗi phân cảnh phải bao gồm ĐÚNG 4 phần:
1. Mô Tả Cảnh (VI): Mô tả bối cảnh ngắn gọn.
2. Prompt Ảnh (EN): Lệnh tiếng Anh tạo ảnh tĩnh. Chứa chi tiết bối cảnh, ánh sáng (bright and airy), chất liệu và tỷ lệ (8k, photorealistic).
...
[VÍ DỤ TIÊU CHUẨN]
- Prompt Ảnh (EN): Close up of tired hands holding a wet mop over a modern bucket, modern well-lit bathroom background, frustrated facial expression, lifestyle commercial photography, bright and airy lighting, soft natural light, clean aesthetic but slightly messy situation, photorealistic, 8k.
- Prompt Video (EN): Slow motion camera panning over the wet mop, subtle frustrated hand movement, smooth lifestyle commercial video feel, fluid motion.

Hãy phân tích và bóc tách kịch bản đầu vào ngay bây giờ theo các quy tắc trên! Trả về định dạng JSON mảng các đối tượng chứa: { "description", "imagePrompt", "videoPrompt", "voiceScript" }.
